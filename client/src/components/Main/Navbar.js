...
export default function Navbar(){
    ...
    // The purpose of this use effect is to prevent users from just typing in a route path and being allowed access there
    // without being logged in as a registered user. This use effect will run each time the navbar is mounted. For this
    // reason the navbar is mounted on every page
